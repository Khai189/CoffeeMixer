            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-center gap-3">
                    <likeFetcher.Form method="post" action="/?index">
                        ...
                        <button
                            type="submit"
                            className={`flex items-center gap-1 transition-colors focus:outline-none focus:ring-2 focus:ring-red-400 rounded-md p-1 ${isLiked ? "text-red-500" : "text-gray-400 hover:text-red-500"}`}
                    ...
                    <saveFetcher.Form method="post" action="/?index">
                        ...
                        <button
                            type="submit"
                            className={`transition-colors focus:outline-none focus:ring-2 focus:ring-amber-400 rounded-md p-1 ${isSaved ? "text-amber-500" : "text-gray-400 hover:text-amber-500"}`}
